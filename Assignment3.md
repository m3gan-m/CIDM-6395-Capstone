...
•	How Software Systems is integratable with your prior work       | *In my career, there is an increased use of data and software when studying data across the enterprise, from Member Identity Access Management to Financials to Workforce. These complex systems are full of large data sets needed to solve complex problems. A large part of the work my team does is Data Visualization and Reporting. This work is key for not only our main roll up organization but the enterprise as a whole. We focus on integrating data analytics into software tools like Tableau, and this enables our team to create interactive dashboards, reports and visualizations. We then demo and present these tools for our customers and they in turn, as a user, are able to explore and understand the data easily, look for patterns and use the tool to communicate insights. Overall the work my team does empowers our area to take complex data and present it to stakeholders in a visual manner that is digestable and quick so those individuals are armed with the proper information to make data driven decisions quickly. Overall, my work as an analyst - starting from a business analyst, then a technology business analyst and now a decision science analylst - the combination of software and systems to create wonderful applications enable data analytics to be at the most efficency and therfore provide keen insights. This results in enhanced performance and growth for not just our company but any which follows a similar method. Currently, within our organization more effort is being prioritized on automation, artifical intelligence and machine learning. This is to help increase the focus on privacy, security and ethics. My role is only enhanced by system development as it removes manual and tedious processes so more focus can be placed on the truly important matters.*
